...
Многоязычная утилита для декодирования и анализа JWT (JSON Web Tokens).  
Поддерживает расшифровку заголовка и полезной нагрузки, проверку срока действия, верификацию подписи (HMAC).
...
- Верификация подписи с использованием HMAC (при указании секретного ключа).
